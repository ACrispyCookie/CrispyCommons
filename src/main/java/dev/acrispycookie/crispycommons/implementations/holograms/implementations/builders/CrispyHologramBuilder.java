...
import dev.acrispycookie.crispycommons.implementations.holograms.implementations.PublicCrispyHologram;
import dev.acrispycookie.crispycommons.implementations.holograms.implementations.SimpleCrispyHologram;
...
public class CrispyHologramBuilder {
    ...
    public CrispyHologramBuilder timeToLive(int tickLifetime) {
