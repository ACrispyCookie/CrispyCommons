...
public class CrispyItemStack extends ItemStack implements CrispyItem {
     ...
     */
    public CrispyItemStack(@NotNull Material material) {
        super(material);
        amount(1);
    }
     ...
     *
     * @param mat the {@link Material} to set for this item stack.
     * @param amount the amount of items in this stack.
     * @param durability the durability value to set for this item stack.
     */
    public CrispyItemStack(@NotNull Material mat, int amount, short durability) {
     ...
     *
     * @param mat the {@link Material} to set.
     * @return the updated {@link CrispyItemStack} instance.
     */
    public @NotNull CrispyItemStack material(@NotNull Material mat) {
        this.setType(mat);
        return this;
    }
