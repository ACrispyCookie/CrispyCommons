...
public class NBTTagCompound_1_20_R4 extends NBTBase_1_20_R4 implements NBTTagCompound {

    private final net.minecraft.server.v1_8_R3.NBTTagCompound wrapped;

    public NBTTagCompound_1_20_R4() {
        wrapped = new net.minecraft.server.v1_8_R3.NBTTagCompound();
        setBase(wrapped);
    }

    public NBTTagCompound_1_20_R4(net.minecraft.server.v1_8_R3.NBTTagCompound tag) {
        wrapped = tag;
        setBase(wrapped);
    }
    ...
    public void set(String key, NBTBase value) {
        wrapped.set(key, ((NBTBase_1_20_R4) value).getInternal());
    }
    ...
    public NBTBase get(String key) {
        NBTBase_1_20_R4 base = new NBTBase_1_20_R4();
