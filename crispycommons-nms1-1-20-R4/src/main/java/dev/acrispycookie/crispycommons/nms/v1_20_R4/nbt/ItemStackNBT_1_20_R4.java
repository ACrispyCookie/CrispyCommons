...
public class ItemStackNBT_1_20_R4 implements ItemStackNBT {
    ...
    public ItemStack addTag(ItemStack i, String identifier, NBTBase value) {
        ...
        tag.set(identifier, ((NBTBase_1_20_R4) value).getInternal());
        nmsItem.setTag(tag);
    ...
    public NBTBase getTag(ItemStack i, String identifier) {
        ...
        if(nmsItem.hasTag() && nmsItem.getTag().hasKey(identifier)) {
            return new NBTBase_1_20_R4(nmsItem.getTag().get(identifier));
        }
        return null;
    }
