package dev.acrispycookie.crispycommons.nms.v1_20_R3.entity.spigot;
...
public class VersionItem_1_20_R3 extends VersionEntity_1_20_R3 implements VersionItem {
    ...
    public VersionItem_1_20_R3(Location location, CrispyItemStack stack) {
        item = new EntityItem(((CraftWorld) location.getWorld()).getHandle(), location.getX(), location.getY(), location.getZ(), CraftItemStack.asNMSCopy(stack));
    }
