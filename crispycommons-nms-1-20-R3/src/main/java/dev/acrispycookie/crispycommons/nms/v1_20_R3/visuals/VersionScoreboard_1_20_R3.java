package dev.acrispycookie.crispycommons.nms.v1_20_R3.visuals;
...
public class VersionScoreboard_1_20_R3 implements VersionScoreboard {
    ...
    public void show(Player p, Component title, List<Component> lines) {
        init(p);
        sendObjective(p, title, ObjectiveAction.UPDATE);
    ...
    @Override
    public void resetTitle(Player p, Component title) {
        sendObjective(p, title, ObjectiveAction.UPDATE);
    }
