package dev.acrispycookie.crispycommons.logging;
...
/**
 * A utility class for logging messages and exceptions in a {@link CrispyPlugin}.
 * <p>
...
public class CrispyLogger {
     ...
     *
     * @param plugin  the {@link CrispyPlugin} instance to use for logging.
     * @param level   the {@link Level} at which the message should be logged.
     * @param message the message to log.
     */
    public static void log(@NotNull CrispyPlugin plugin, @NotNull Level level, @NotNull String message) {
     ...
     */
    public static void printException(@NotNull CrispyPlugin plugin, @NotNull Exception exception, @NotNull String message) {
