...
public abstract class CommandRegister implements Versioned {
    ...
    public abstract boolean register(@NotNull SpigotCrispyPlugin plugin, @NotNull String fallbackPrefix, @NotNull Command command);
    public abstract @NotNull CommandMap unregister(@NotNull SpigotCrispyPlugin plugin, @NotNull String label);
